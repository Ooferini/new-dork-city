  ...
  return (
    <div className='lg:mx-auto lg:w-1/2 border-black border-2 md:border-y-none flex flex-col'>
      ...
      <div className='mx-6 py-6 border-b-2 text-xl'>
        Gould Plaza is an outdoor plaza located on West 4th Street between
        Washington Square East and Mercer Street. Since 1892, the Gould family
        has been exceptionally generous to New York University. To express its
        gratitude, the University named this plaza in memory of Frank Jay Gould
        of the class of 1899, his father, Jay Gould, and his sister, Helen Gould
